...
_BRAND_COPY_HINTS: dict[str, str] = {
    "homestein": """\
WSKAZÓWKI HOMESTEIN (meble do wnętrz):
...
3. Zero duplikatów słów.
   ...
   ✗ "HOMESTEIN DEMU HOMESTEIN" (marka 2×)
...
2. ✓ "KRZESŁO TAPICEROWANE DO JADALNI CZARNE Z OPARCIEM HOMESTEIN DENIA"
   ✗ "KRZESŁO PRAKTYCZNE WYJĄTKOWE HOMESTEIN" (papka, brak koloru/typu)

3. ✓ "SKRZYNKA NA LISTY STALOWA NA OGRODZENIE CZARNA HOMESTEIN 40 X 40 X 15 CM"
   ✗ "SKRZYNKA NA LISTY STALOWA OGRODZENIOWA HOMESTEIN 40X40X15 CM"
     (kalka słowotwórcza "OGRODZENIOWA", brak spacji wymiaru, brak koloru)

4. ✓ "BIURKO Z REGAŁEM DO POKOJU 90 X 40 CM HOMESTEIN EVORA"
   ✗ "BIURKO BIUROWE Z REGAŁEM 90X40 CM PRAKTYCZNE HOMESTEIN"
     (BIURKO BIUROWE = redundancja, PRAKTYCZNE = filler, marka na końcu, zły format)

5. ✓ "REGAŁ DREWNIANY 5 PÓŁEK CZARNY HOMESTEIN TOLEDO 58 X 23 X 5 CM"
   ✗ "REGAŁ NOWOCZESNY DOMOWY REGAŁ 5 PÓŁEK CZARNY TOLEDO HOMESTEIN"
     (duplikat REGAŁ, NOWOCZESNY+DOMOWY = filler, brak wymiaru)

6. ✓ "KOMPLET 4 KRZESEŁ TAPICEROWANYCH DO JADALNI SZARYCH HOMESTEIN AVEIRO"
   ✗ "ZESTAW KRZESEŁ TAPICEROWANYCH SZARYCH 4 SZTUKI HOMESTEIN DENIA Z OPARCIEM"
...
9. ✗ ZA KRÓTKIE (47 zn) "BIURKO Z REGAŁEM BIAŁE 90 X 40 CM HOMESTEIN EVORA"
   ✓ POPRAWIONE (66 zn) "BIURKO Z REGAŁEM DO POKOJU MŁODZIEŻOWEGO BIAŁE 90 X 40 CM HOMESTEIN EVORA"
